...
class Card:NSObject,NSCoding{
    ...
    init(title:String,tag:String,description:String,id:String,definition:String,examples:[String],color:UIColor) {
        self.title = title
        self.tag = tag
    ...
    func appendExamples(_ examples:[String]){
        self.examples.append(contentsOf: examples)
    }
    func appendExample(_ example:String){
