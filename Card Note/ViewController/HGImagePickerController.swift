...
class HGImagePickerController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //添加导航栏右侧的取消按钮
        let rightBarItem = UIBarButtonItem(title: "Cancel", style: .plain, target: self,
...
extension PHAsset {
    func getImage(completionHandler:@escaping (UIImage)->()){
        ...
        imageManager.requestImage(for: self, targetSize: CGSize(width: self.pixelWidth, height: self.pixelHeight), contentMode: .default, options: requestOptions) { (image, _) in
